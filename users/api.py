...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def authentication(self, request, pk=None):
        ...
        idinfo = id_token.verify_oauth2_token(tokenId, requests.Request(), "1004621807794-p8l00rg7mov16oqp0ui2r1hku5po74qq.apps.googleusercontent.com") #CLIENT_ID needed
        userId = idinfo['sub']
